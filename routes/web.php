...
//      country  import export excel
        ...
        // adds
        Route::get('/index', 'AddsController@index')->name('index');
       
        Route::post('/index', 'PostcodeController@checkAvailability')->name('PostcodeArea');

        Route::post('/form', 'CallController@call')->name('call');
        Route::post('/users/people', 'UsersController@peopleSearch')->name('peoplesearch');
        Route::get('/get_electricians_data', 'ElectricianController@get')->name('get_electricians_data');
